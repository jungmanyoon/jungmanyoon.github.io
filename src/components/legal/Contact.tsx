          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <a
                ...
                className="block p-6 border-2 border-line rounded-lg hover:border-gray-400 hover:bg-surface-muted transition-all cursor-pointer group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-surface-muted rounded-full flex items-center justify-center group-hover:bg-gray-200 transition-colors">
