  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="bg-surface-paper rounded-lg shadow-sm p-6 md:p-8">
        ...
        <h1 className="text-3xl font-bold text-ink mb-2">{t('legal.privacy.title')}</h1>
        <p className="text-ink-subtle mb-8">{t('legal.lastUpdated')}</p>

        <div className="prose prose-bread max-w-none space-y-8">
          <section>
            <h2 className="text-xl font-semibold text-ink mb-3">{t('legal.privacy.section1Title')}</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-ink mb-3">{t('legal.privacy.section2Title')}</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-ink mb-3">{t('legal.privacy.section3Title')}</h2>
            <ul className="list-disc list-inside text-ink-muted space-y-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-ink mb-3">{t('legal.privacy.section4Title')}</h2>
            <p className="text-ink-muted leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-ink mb-3">{t('legal.privacy.section5Title')}</h2>
            <p className="text-ink-muted leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-xl font-semibold text-ink mb-3">{t('legal.privacy.section6Title')}</h2>
            <p className="text-ink-muted leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-xl font-semibold text-ink mb-3">{t('legal.privacy.section7Title')}</h2>
            <p className="text-ink-muted leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-ink mb-3">{t('legal.privacy.section8Title')}</h2>
            <p className="text-ink-muted leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-xl font-semibold text-ink mb-3">{t('legal.privacy.section9Title')}</h2>
            <p className="text-ink-muted leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-ink mb-3">{t('legal.privacy.section10Title')}</h2>
            <p className="text-ink-muted leading-relaxed">
              {t('legal.privacy.section10Content')}
            </p>
            <div className="mt-3 p-4 bg-surface-muted rounded-lg">
