  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="bg-surface-paper rounded-lg shadow-sm p-6 md:p-8">
        ...
        <h1 className="text-3xl font-bold text-ink mb-2">사용 가이드</h1>
        <p className="text-ink-subtle mb-8">레시피북 - 제과제빵 레시피 변환기 완벽 활용법</p>

        <div className="prose prose-bread max-w-none space-y-10">
          {/* 소개 섹션 */}
          <section className="bg-surface-muted p-6 rounded-lg">
            <h2 className="text-xl font-semibold text-ink mb-3">서비스 소개</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-ink mb-4 flex items-center gap-2">
              <span className="bg-surface-muted text-ink-muted px-3 py-1 rounded-full text-sm">1</span>
            ...
            <div className="bg-surface-muted p-4 rounded-lg mb-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-surface-paper p-3 rounded border">
                  <p className="text-sm text-ink-subtle mb-2">예시: 기본 식빵 레시피</p>
                ...
                <div className="bg-surface-paper p-3 rounded border">
                  <p className="text-sm text-ink-subtle mb-2">장점</p>
                  <ul className="text-sm text-ink-muted space-y-1">
                    <li>✓ 레시피 스케일링이 쉬움</li>
                    <li>✓ 재료 비율을 한눈에 파악</li>
                    <li>✓ 수화율 즉시 확인</li>
            ...
            <h3 className="font-medium text-ink-muted mb-2">사용 방법</h3>
            <ol className="list-decimal list-inside text-ink-muted space-y-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-ink mb-4 flex items-center gap-2">
              <span className="bg-surface-muted text-ink-muted px-3 py-1 rounded-full text-sm">2</span>
              DDT 계산기 (반죽 온도 계산)
            </h2>
            <div className="bg-surface-muted p-4 rounded-lg mb-4">
              <p className="text-ink-muted mb-3">
              ...
              <div className="bg-surface-paper p-3 rounded border">
                <p className="text-sm font-medium text-ink-muted mb-2">DDT 공식</p>
                <p className="text-sm text-ink-muted font-mono bg-surface-muted p-2 rounded">
                  물 온도 = (DDT × 계수) - 실온 - 밀가루온도 - 마찰계수
                </p>
              </div>
            </div>
            <h3 className="font-medium text-ink-muted mb-2">입력 항목</h3>
          ...
          <section>
            <h2 className="text-xl font-semibold text-ink mb-4 flex items-center gap-2">
              <span className="bg-surface-muted text-ink-muted px-3 py-1 rounded-full text-sm">3</span>
              팬 크기별 레시피 조정
            </h2>
            ...
            <div className="grid md:grid-cols-3 gap-3 mb-4">
              <div className="bg-surface-muted p-3 rounded text-center">
                <div className="text-2xl mb-1">⭕</div>
                <p className="text-sm font-medium">원형 팬</p>
                <p className="text-xs text-ink-subtle">케이크, 파이</p>
              </div>
              <div className="bg-surface-muted p-3 rounded text-center">
                <div className="text-2xl mb-1">⬜</div>
                <p className="text-sm font-medium">사각 팬</p>
                <p className="text-xs text-ink-subtle">브라우니, 시트케이크</p>
              </div>
              <div className="bg-surface-muted p-3 rounded text-center">
                <div className="text-2xl mb-1">📦</div>
                <p className="text-sm font-medium">식빵 팬</p>
                <p className="text-xs text-ink-subtle">식빵, 파운드케이크</p>
              </div>
            </div>
            <h3 className="font-medium text-ink-muted mb-2">조정 원리</h3>
          ...
          <section>
            <h2 className="text-xl font-semibold text-ink mb-4 flex items-center gap-2">
              <span className="bg-surface-muted text-ink-muted px-3 py-1 rounded-full text-sm">4</span>
              환경 조건 보정
            </h2>
            <p className="text-ink-muted mb-4">
            ...
            <div className="grid md:grid-cols-3 gap-3">
              <div className="border p-3 rounded">
                <h4 className="font-medium text-ink-muted mb-1">🌡️ 온도</h4>
                <p className="text-sm text-ink-subtle">발효 속도, 버터 상태에 영향</p>
              </div>
              <div className="border p-3 rounded">
                <h4 className="font-medium text-ink-muted mb-1">💧 습도</h4>
                <p className="text-sm text-ink-subtle">수분량 조정 필요</p>
              </div>
              <div className="border p-3 rounded">
                <h4 className="font-medium text-ink-muted mb-1">⛰️ 고도</h4>
                <p className="text-sm text-ink-subtle">팽창제, 온도 조정</p>
              </div>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold text-ink mb-4 flex items-center gap-2">
              <span className="bg-surface-muted text-ink-muted px-3 py-1 rounded-full text-sm">5</span>
              레시피 저장 및 관리
            </h2>
            <ul className="list-disc list-inside text-ink-muted space-y-2">
          ...
          {/* 팁 */}
          <section className="bg-surface-muted p-6 rounded-lg">
            <h2 className="text-xl font-semibold text-ink mb-4 flex items-center gap-2"><Lightbulb size={18} className="text-ink-muted" /> 베이킹 팁</h2>
          ...
          <section className="text-center py-6">
            <h2 className="text-xl font-semibold text-ink mb-4">지금 바로 시작하세요!</h2>
